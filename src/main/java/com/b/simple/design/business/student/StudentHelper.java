...
public class StudentHelper {
	...
	*/
	public boolean isGradeB(int marks, boolean isMaths) {
		int lowerLimit = 51;
		int upperLimit = 80;
		boolean mathsLimit = marks>=lowerLimit && marks<=upperLimit+10;
		boolean limitOtherthanMaths = marks>=lowerLimit && marks<=upperLimit;
		return isMaths ? mathsLimit : limitOtherthanMaths; 
	}
